...
namespace RestaurantBackend.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_CategoryMenuItems_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_RoleUsers_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), "Основные блюда" },
                    { new Guid("10000000-0000-0000-0000-000000000002"), "Закуски" },
                    { new Guid("10000000-0000-0000-0000-000000000003"), "Напитки" },
                    { new Guid("10000000-0000-0000-0000-000000000004"), "Десерты" }
                });
